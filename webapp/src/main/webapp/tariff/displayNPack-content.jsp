...
<script language="javascript">
	...
	function openWindow(planUid) {
		window.open("<html:rewrite page="/tariffsPopup.do"/>?operation=listHistNPack" + "&rowSelected=" + planUid,
					"tariffsPopup", "scrollbars,resizable,width=500,height=400");
	}
</script>
		    	...
		    	<table width="100%" align="center" class="table" cellpadding="3" cellspacing="0">
				  	<tr height="20" class="table-column-title">
				    	...
				    	<td width="12%" class="table-title">
			    			<a href="javascript:submitForm('listNPack')" style="color:#FFF;">
		    	...
		    	<td colspan="2" valign="top">
		   		<div id="search-results" class="text8b" style="overflow:auto;width:600px">
		   			...
		   			<logic:notEmpty name="resultList">
						  ...
						  <display:column headerClass="table-column-title" title="Data de efetivação">
						  	 <a href="javascript:openWindow('<c:out value="${listTable.planUid}" />')">
						  	 	<fmt:formatDate value="${listTable.validFrom}" type="DATE" pattern="dd/MM/yyyy"/>
						     </a>
						  </display:column>
						  <!-- 
