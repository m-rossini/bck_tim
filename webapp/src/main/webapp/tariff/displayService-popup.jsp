...
<head>
	<title>:::: <bean:message key="text.serviceTab" bundle="tariff"/> ::::</title>
		...
		<tr>
			<td width="100%" colspan="2" valign="top">
				...
				<logic:notEmpty name="resultList">
				   	<display:table id="listTable" class="text8" name="resultList" cellpadding="2" cellspacing="2">
				   		<display:column headerClass="table-column-title" title="Serviço" maxLength="32">
				   			<c:out value="${listTable.description}"/>(<c:out value="${listTable.shortDesc}"/>)
				   		</display:column>
					  	<display:column headerClass="table-column-title" property="planDescr"     title="Plano"   	  maxLength="20"/>
