...
<script language="javascript">
	...
	<td>
        ...
        <!--                          -->
		<bean:define id="progDiscountRatesInfo" name="<%=RequestScopeConstants.REQUEST_REQID_KEY%>" scope="request"/>
					...
					<TABLE class="table" width="100%">
						...
						<TR height="60">
							...
							<TD colspan="2" class="text8" align="left">
								<bean:message key="message.result.discRangePreFix" bundle="progressiveDiscount"/>
...
<logic:equal name="<%=RequestScopeConstants.REQUEST_OPERATION_DATA%>" scope="request" value="<%=RequestScopeConstants.REQUEST_OPERATION_TYPE_DELETE%>">
								...
								<BR/>
								<BR/>
								<A href="<html:rewrite page="/discountTable.do"/>?discountUid=<bean:write name="discountUid"/>&operation=detail&discountDescUid=<bean:write name="discountDescUid"/>"><bean:message key="clickHere.return" bundle="progressiveDiscount"/></A>
							</TD>
							<TD width="10%"/>
						</TR>
					</TABLE>
