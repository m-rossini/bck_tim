...
${ORACLE_HOME}/bin/sqlldr userid=${DB_USER}/${DB_PWD} readsize=20000000 bindsize=20000000 errors=99999999 control=ldr/usagegroup.ldr data=${DATAFILE} log=log/usagegrp.log

echo Running loader for tariff zone and usage group association
${ORACLE_HOME}/bin/sqlldr userid=${DB_USER}/${DB_PWD} readsize=20000000 bindsize=20000000 errors=99999999 control=ldr/tariffzone_usage.ldr data=${DATAFILE} log=log/tariffzone_usagegroup.log
